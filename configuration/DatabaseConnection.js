...
mongoose.connect('mongodb+srv://trust4pay:trust4pay@trust4pay.tcvhb.mongodb.net/trust4pay?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true }, (error,connection) => {
    if (!error) {
